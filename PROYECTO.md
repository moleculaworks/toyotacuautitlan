...
- [ ] Cargar el resto de los 18 modelos restantes (6/24 publicados: Corolla, Corolla HEV, Camry HEV, Yaris Sedán, Yaris Sedán HEV, Yaris Hatchback) (datos desde fichas técnicas + toyota.mx, precio siempre desde toyota.mx; imágenes las trabaja Raúl en Photoshop) — proceso ya probado: borrador en JSON (`JSON Modelos/`) → revisión visual → aprobación → Sanity → publicar
