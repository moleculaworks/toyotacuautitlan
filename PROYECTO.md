...
- [ ] Cargar el resto de los 21 modelos restantes (datos desde fichas técnicas + toyota.mx, precio siempre desde toyota.mx; imágenes las trabaja Raúl en Photoshop) — proceso ya probado con Corolla HEV y Camry HEV: borrador en JSON (`JSON Modelos/`) → revisión visual → aprobación → Sanity → publicar
