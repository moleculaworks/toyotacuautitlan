    ...
    <div className="bg-[#F5F5F5] min-h-screen py-12">
      <div className="max-w-2xl mx-auto px-4 sm:px-6">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-semibold text-foreground">Agenda tu cita de servicio</h1>
        ...
        <div className="mt-6 bg-white border border-[#E8E8E8] p-4">
          <h2 className="text-sm font-semibold text-foreground mb-3">Nuestro taller ofrece:</h2>
          <ul className="grid grid-cols-2 gap-2">
            {[
              ...
              <li key={s} className="flex items-center gap-2 text-sm text-gray-600">
                <span className="w-1.5 h-1.5 rounded-full bg-toyota-red flex-shrink-0" />
                {s}
              </li>
            ))}
          </ul>
